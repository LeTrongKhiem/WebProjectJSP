                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<%=request.getContextPath()%>/admin/editBanner" method="post">
                                            <div class="my-4 table-editor_input-wrapper">
                                                <div class="form-outline "><input type="text" name="bannerID" autofocus
                                                                                  class="table-editor__input form-control" value="${detailBanner.bannerID}" readonly>
                                                    <label class="form-label" style="margin-left: 0px;">banner id</label>
                                            ...
                                            <div class="my-4 table-editor_input-wrapper" data-mdb-field="Ehinhanh">
                                                <div class="form-outline "><input type="text" name="Ehinhanh"  value="${detailBanner.hinhanh}"
                                            ...
                                            <div class="my-4 table-editor_input-wrapper" data-mdb-field="tsp">
                                                <div class="form-outline "><input type="text" name="Elvd"
                                                                                  class="table-editor__input form-control" value="${detailBanner.link_video}">
                                            ...
                                            <div class="my-4 table-editor_input-wrapper" data-mdb-field="Elbc">
                                                <div class="form-outline "><input type="text" name="Elbc"
                                                                                  class="table-editor__input form-control" value="${detailBanner.link_banner_content}">
                                                    <label class="form-label" style="margin-left: 0px;">link banner content</label>
                                                    <div class="form-notch">
                                                        <div class="form-notch-leading" style="width: 9px;"></div>
                                                        <div class="form-notch-middle" style="width: 82.4px;"></div>
                                                        <div class="form-notch-trailing"></div>
