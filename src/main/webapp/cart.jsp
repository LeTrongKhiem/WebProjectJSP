        ...
        <%@include file="common/taglib.jsp" %>
            <%-- request.setCharacterEncoding("UTF-8");--%>
                <%-- response.setCharacterEncoding("UTF-8");--%>
                    ...
                    <%--<jsp:useBean id="cart" scope="request" type="com.example.webproject.BEAN.Cart" />--%>
                    <%--<jsp:useBean id="a" class="com.example.webproject.DAO.daoimpl.ProductListDAOImpl"
                        scope="request">
                        </jsp:useBean>--%>
                        <!DOCTYPE html>
                        <html lang="en">
                        ...
                        <head>
                            ...
                            <link rel="stylesheet"
                                href="<c:url value= './assets/font/fontawesome-free-5.15.3-web/css/all.css'/>">
                                                ...
                                                <div class="table-responsive cart-cal  text-center">
                                                    <table class="table" id="table">
                                                        <thead>
                                                            <tr class="table-head">
                                                                <th>Hình ảnh</th>
                                                                <th class="th_description">Thông tin sản phẩm
                                                                </th>
                                                                <th>&nbsp;</th>
                                                                <th>&nbsp;</th>
                                                                <th>Số lượng</th>
                                                            ...
                                                            <jsp:useBean id="cart" scope="request"
                                                                type="com.example.webproject.BEAN.Cart" />
                                                        ...
                                                        <tbody class="shadow-around">
                                                            ...
                                                            <c:forEach items="${products}" var="product">
                                                                ...
                                                                <tr class="table-body">
                                                                    <td>
                                                                        <figure><img src="${product.link_hinhanh}"
                                                                                style="width:160px" /></figure>
                                                                    </td>
                                                                    <td>
                                                                        <div
                                                                            class="cart-wrappper text-left th_description">
                                                                            <h6>${product.tenSP}</h6>
                                                                            <p><span>Availability</span>:
                                                                                Available in Stock</p>
                                                                            <p><span>Product Code</span>: CwT4a
                                                                            </p>
                                                                        </div>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                    ...
                                                                    <td>
                                                                        <%-- <span
                                                                            class="btn-cart btn-square btn-plus btn-qty">
                                                                            <i--%>
                                                                                <%-- class="fa fa-plus">
                                                                                    </i></span>--%>
                                                                                    ...
                                                                                    <%-- <span
                                                                                        class="btn-cart btn-square btn-minus btn-qty">
                                                                                        <i--%>
                                                                                            <%-- class="fa fa-minus">
                                                                                                </i></span>--%>
                                                                    ...
                                                                    <td><span
                                                                            class="cart-price">${product.dinhDang(product.giaSP)}</span>
                                                                    </td>
                                                                    <td>
                                                                        <ul class="cart-action">
                                                                            <li><a pid="${product.maSP}"
                                                                                    class="btn-cart btn-delete btn-blue"><i
                                                                ...
                                                                <%-- <jsp:useBean id="error" scope="request"
                                                                    type="com.example.webproject.controller.cart.UpdateQuantityController" />
                                                                --%>
                                                                <%-- <tr>${error}</tr>--%>
                                                            </c:forEach>
