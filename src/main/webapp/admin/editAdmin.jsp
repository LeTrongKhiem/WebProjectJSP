                                        ...
                                        <form action="<%=request.getContextPath()%>/admin/editAdmin" method="post">
                                            <div class="my-4 table-editor_input-wrapper">
                                                <div class="form-outline "><input type="text" name="eId" autofocus
                                                                                  class="table-editor__input form-control" value="${detailAdmin.id}" readonly>
                                            ...
                                            <div class="my-4 table-editor_input-wrapper" data-mdb-field="tsp">
                                                <div class="form-outline "><input type="text" name="eMatKhau"  value="${detailAdmin.matKhau}"
                                            ...
                                            <div class="my-4 table-editor_input-wrapper" data-mdb-field="tsp">
                                                <div class="form-outline "><input type="text" name="eHoTen"
                                                                                  class="table-editor__input form-control" value="${detailAdmin.hoTen}">
                                            ...
                                            <div class="my-4 table-editor_input-wrapper" data-mdb-field="tsp">
                                                <div class="form-outline "><input type="text" name="eEmail"
                                                                                  class="table-editor__input form-control" value="${detailAdmin.email}">
                                            ...
                                            <div class="my-4 table-editor_input-wrapper" data-mdb-field="tsp">
                                                <div class="form-outline "><input type="text" name="eSDT"
                                                                                  class="table-editor__input form-control" value="${detailAdmin.sDT}">
                                            ...
                                            <div class="my-4 table-editor_input-wrapper" data-mdb-field="tsp">
                                                <div class="form-outline "><input type="date" name="eNgayBD"
                                                                                  class="table-editor__input form-control" value="${detailAdmin.ngayBatDau}">
                                            ...
                                            <div class="my-4 table-editor_input-wrapper" data-mdb-field="tsp">
                                                <div class="form-outline "><input type="text" name="eQuyen"
                                                                                  class="table-editor__input form-control" value="${detailAdmin.quyen}">
                                            ...
                                            <div class="my-4 table-editor_input-wrapper" data-mdb-field="tsp">
                                                <div class="form-outline "><input type="text" name="eRole"
                                                                                  class="table-editor__input form-control" value="${detailAdmin.role}">
                                            ...
                                            <div class="my-4 table-editor_input-wrapper" data-mdb-field="tsp">
                                                <div class="form-outline "><input type="text" name="eActive"
                                                                                  class="table-editor__input form-control" value="${detailAdmin.active}">
                                            ...
                                            <div class="my-4 table-editor_input-wrapper" data-mdb-field="tsp">
                                                <div class="form-outline "><input type="text" name="eCode"
                                                                                  class="table-editor__input form-control" value="${detailAdmin.code}">
                                            ...
                                            <div class="my-4 table-editor_input-wrapper" data-mdb-field="tsp">
                                                <div class="form-outline "><input type="text" name="eAddress"
                                                                                  class="table-editor__input form-control" value="${detailAdmin.address}">
                                                    <label class="form-label" style="margin-left: 0px;">Address</label>
                                                    <div class="form-notch">
                                                        <div class="form-notch-leading" style="width: 9px;"></div>
                                                        <div class="form-notch-middle" style="width: 82.4px;"></div>
                                                        <div class="form-notch-trailing"></div>
