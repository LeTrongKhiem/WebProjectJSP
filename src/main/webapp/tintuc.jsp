    ...
    <div class="news-content">
        <div class="news-content-list">
            <div class="news-content-item news-main">
                ...
                <div class="description"> Chào mừng Quý khách đã trở lại với Bản Tin Công Nghệ của MobileCity, cập nhật
                    tin tức công nghệ hot nhất trong 24h qua.
            ...
            <div class="news-content-right">
                <div class="news-item">
                    ...
                    <div class="img">
                        <a href="https://mobilecity.vn/tin-tuc/bat-ngo-lo-thong-tin-bphone-dao-nhai-truoc-gio-ra-mat.html"><img
                                class="lazy" src="https://cdn.mobilecity.vn/mobilecity-vn/images/2021/12/bphone-4-1.jpg"
                ...
                <div class="news-item">
                    ...
                    <div class="description">
                        <div class="text"> Vào ngày 9 tháng 12, Motorola đã công bố điện thoại thông minh Moto Edge X30
                            và Edge S30 tại Trung Quốc. Trong đợt bán X30 đầu tiên diễn ra vào ngày 15/12 tại Trung
                            Quốc, Motorola đã bán được 10.000 chiếc điện thoại này trong vòng chưa đầy 3 phút. Như đã
                            biết, X30 ra mắt là điện thoại đầu tiên trên ...
                        </div>
                        <div class="infor-meta">
                        ...
                        <div class="news-content-item">
                            ...
                            <div class="right">
                                <div class="detail">
                                    ...
                                    <div class="infor-meta">
                                        <div class="news_author"><i class="fa fa-user-circle" aria-hidden="true"></i>
                                            Đặng Ái Vân
                                        </div>
                                        <div class="time" style="margin-right: 10px">11:56 26/12/2021</div>
                                        <p class="infor-meta__comment">
                        ...
                        <div class="news-content-item">
                            ...
                            <div class="right">
                                <div class="detail">
                                    ...
                                    <div class="description">
                                        <div class="text"> Oppo Reno7 được ra mắt vào tháng trước đã có một phiên bản
                                            đặc biệt, được gọi là Oppo Reno7 New Year Edition. Máy có màu Red Velvet (Đỏ
                                            nhung) và có biểu tượng con hổ ở mặt sau, cạnh logo Oppo vì năm 2022 là năm
                                            Nhâm Dần trong âm lịch Trung Quốc.
                                    ...
                                    <div class="infor-meta">
                                        ...
                                        <p class="infor-meta__view"><i class="fa fa-eye" aria-hidden="true"></i>95</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="right">
                                <div class="detail">
                                    <h3 class="name"><a
                                        ...
                                        dùng OnePlus sẽ có toàn quyền truy cập vào các trung tâm dịch vụ sau bán hàng
                                        của OPPO</a></h3>
                                    <div class="description">
                                        <div class="text"> Người dùng OnePlus sẽ có toàn quyền truy cập vào các trung
                                            tâm dịch vụ sau bán hàng của OPPO từ ngày 1 tháng 1 năm 2022.
                                    ...
                                    <div class="infor-meta">
                                        ...
                                        <p class="infor-meta__view"><i class="fa fa-eye" aria-hidden="true"></i>59</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="product-sidebar">
                ...
                <div class="product-sidebar-list">
                    <div class="product-sidebar-item">
                        ...
                        <p class="name"><a href="https://mobilecity.vn/asus/asus-rog-phone-5s.html">Asus ROG Phone 5S
                            (Snap 888+)</a></p>
                        <p class="price">14.450.000 ₫</p>
                    </div>
                    <div class="product-sidebar-item">
                        ...
                        <p class="name"><a href="https://mobilecity.vn/oppo/realme-gt-neo-2.html">Realme GT Neo 2 (Snap
                            870)</a></p>
                        <p class="price">7.550.000 ₫</p>
                    </div>
                    <div class="product-sidebar-item">
                    ...
                    <div class="product-sidebar-item">
                        ...
                        <p class="name"><a href="https://mobilecity.vn/apple/iphone-11-pro-max-cu.html">iPhone 11 Pro
                            Max cũ (64GB-256GB)</a></p>
                        <p class="price">16.050.000 ₫</p>
                    </div>
                </div>
            </div>
